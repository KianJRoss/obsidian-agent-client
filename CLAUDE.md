...
â”‚   â”œâ”€â”€ models/               # agent-config, agent-error, chat-message, chat-session, session-update
...
â”‚   â”œâ”€â”€ useChat.ts            # Message sending, session update handling
...
- **Flow**: initialize() â†’ newSession() â†’ sendMessage() â†’ sessionUpdate via `onSessionUpdate`
